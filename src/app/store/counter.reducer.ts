...
import { from } from 'rxjs';
 ...
 let lName:formProperties={value:"world",isFocused:false,isTouched:false}
...
export function CounterReducer(state = INITIAL_STATE, action: any): any {
  ...
  switch (action.type) {
    ...
    case ISFOCUSEDFIRSTNAME:
      ...
      //state.value1.isFocused=!state.value1.isFocused;action.data
      state.value1.isFocused=action.data.status;
      break;
